      ...
      <div class="home-event relative py-[46px] pb-[95px]">
        ...
        <div class="-mx-[15px] flex flex-wrap">
          <div
            ...
            class="mt-[52px] w-full px-[15px] text-center"
            :class="boxes.length > 3 ? 'sm:w-1/2 lg:w-1/3' : 'sm:w-1/3'"
          >
            <div class="contact-box inline-block w-full text-center">
              ...
              <p
                v-else-if="box.type === 'text' && box.text"
                class="m-0 whitespace-pre-line px-[30px] text-[#6a6767]"
              >
                {{ box.text }}
              </p>
            </div>
