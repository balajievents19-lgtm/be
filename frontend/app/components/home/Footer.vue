...
const { footer: companyLinks } = useNavigation()
...
const newsletterEnabled = computed(() => props.settings?.footer?.newsletter_enabled !== false)
const socialEnabled = computed(() => props.settings?.footer?.social_enabled !== false)
const footerEnabled = computed(() => props.settings?.footer?.enabled !== false)
            ...
            <div class="inline-block min-h-0 w-full max-w-[157px] text-left md:min-h-[260px] max-[639px]:min-h-0">
              ...
              <ul class="m-0 list-none p-0">
                <li
                  ...
                  :key="link.id ?? `${link.label}-${link.to}`"
                  class="group"
                >
                  <a
                    v-if="link.external"
